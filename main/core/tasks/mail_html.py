...
kwargs = {
    ...
    "logo"        : '<img data-imagetype="External" alt="{}" src="{}{}" height="100">'.format("http://www.g.com", "http://www.g.com", "http://www.g.com/logo.png")
}
...
def mail_html_envelopes(envelopes, subject, html_template, lang=settings.LANGUAGE_CODE):
    envelopes = {"name": "Joe Life", "email": "info@domain.com", "kwargs": "Dictionary of extra"}
    translation.activate(lang)
    mail = PyMailMultiPart(subject=subject, html_template=html_template,)
